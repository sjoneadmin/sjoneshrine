...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-red-50">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-[#FF69B4] via-[#FF1493] to-[#E8452E]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-gradient-to-r from-[#FF69B4] to-[#FF1493] rounded-xl">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {milestones.map((milestone, index) => (
                    <div key={milestone.id} className="relative">
                      <div className={`p-6 rounded-xl border-2 transition-all duration-300 ${
                        milestone.achieved 
                          ? 'bg-gradient-to-r from-[#FF69B4]/10 to-[#FF1493]/10 border-[#FF69B4] shadow-lg' 
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-3">
                              <Badge variant={milestone.achieved ? "default" : "secondary"} className="text-lg px-4 py-2 bg-gradient-to-r from-[#FF69B4] to-[#FF1493] text-white">
            ...
            <div>
                    ...
                    <div key={donation.id} className="p-4 rounded-lg bg-gradient-to-r from-orange-50 to-red-50 border border-[#FF69B4]/20 hover:shadow-md transition-all duration-200">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex flex-col items-end gap-1">
                          <Badge className="bg-gradient-to-r from-[#FF69B4] to-[#FF1493] text-white">
                            ${donation.amount}
                          </Badge>
              ...
              {/* Next Milestone */}
              {nextMilestone && (
                <Card className="mt-6 shadow-xl border-0 bg-gradient-to-r from-[#FF69B4]/10 to-[#FF1493]/10">
                  <CardHeader>
